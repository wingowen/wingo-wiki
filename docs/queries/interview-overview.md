...
- **关联页面**：👉 [context-management](../concepts/context-engineering/core/context-management.md)
...
- 向量存储与 Top-K 检索
- 超大文件处理方案
- **关联页面**：👉 [rag](../concepts/rag/core/rag.md)
...
- **关联页面**：👉 [interview-hyde](../concepts/rag/interview/interview-hyde.md)
...
- C端用户偏好实现：用户画像 + 向量检索
- **关联页面**：👉 [agent-architecture](../concepts/agent-architecture/core/agent-architecture.md)
...
| 问题 | 考察点 | 关联 |
|------|--------|------|
| LangGraph 如何实现循环？ | 图流转机制 | [langgraph](../concepts/other/core/langgraph.md) |
| Checkpointer 原理？ | 状态持久化 | [context-management](../concepts/context-engineering/core/context-management.md) |
| HyDE 幻觉问题？ | RAG 增强原理 | [hyde](../concepts/rag/core/hyde.md) |
| Chunk_size 怎么选？ | RAG 分块策略 | [rag](../concepts/rag/core/rag.md) |
| Agent 安全怎么保证？ | Agent 架构 | [agent-architecture](../concepts/agent-architecture/core/agent-architecture.md) |
